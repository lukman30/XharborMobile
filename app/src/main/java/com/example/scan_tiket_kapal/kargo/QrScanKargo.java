...
import com.example.scan_tiket_kapal.penumpang.HasilScanPenumpang;
import com.example.scan_tiket_kapal.penumpang.QrScannerPenumpang;
import com.google.zxing.Result;

import me.dm7.barcodescanner.zxing.ZXingScannerView;

public class QrScanKargo extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(QrScanKargo.this);
...
//        System.out.println(result);
        ...
        Intent update = new Intent(this, HasilScanKargo.class);
